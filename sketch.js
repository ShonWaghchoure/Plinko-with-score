...
function preload(){
  One = loadSound("sounds/Hundred.m4a");
  Two = loadSound("sounds/TwoHundred.m4a");
  Three = loadSound("sounds/ThreeHundred.m4a");
  Four = loadSound("sounds/FourHundred.m4a");
  Five = loadSound("sounds/FiveHundred.m4a");

  Won = loadSound("sounds/Congratulations.m4a");
  Lose = loadSound("sounds/BetterLuck.m4a");
